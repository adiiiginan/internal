<div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
    ...
    <a href="index.html" class="app-sidebar-logo">
        <img alt="Logo" src="{{ asset('backend/assets/media/logos/demo39.svg') }}"
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                ...
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="d-flex flex-column">
                        <div class="fw-bold d-flex align-items-center fs-5">
                            {{ optional(Auth::user())->nama ?? (optional(Auth::user())->user ?? 'Guest') }}
                        </div>
                        <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">
                            {{ optional(Auth::user())->email ?? (optional(Auth::user())->user ?? 'user@example.com') }}
                        </a>
                    </div>
                    <!--end::Username-->
                </div>
            ...
            <div class="menu-item px-5">
                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="btn btn-sm btn-light fw-bold btn-active-light-primary w-100 d-flex align-items-center justify-content-center">
                        <i class="ki-outline ki-logout fs-3 me-2"></i>
                        Logout
                    </button>
                </form>
            </div>
